<!-- resources/views/bodegas/create.blade.php -->
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form method="POST" action="{{ route('bodegas.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="sucursal_id" name="sucursal_id" maxlength="36" class="block w-full bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
